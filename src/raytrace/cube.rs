...
use super::ray::Ray;
use super::rectangle::{FlipNormal, XY, XZ, YZ};
use super::vec::Vec3;
...
impl Cube {
    pub fn new(p0: Vec3, p1: Vec3, material: Arc<dyn Material>) -> Self {
        ...
        cuboid.add(FlipNormal::new(Box::new(XY::new(
            p0.x(),
            p1.x(),
            p0.y(),
            p1.y(),
        ...
        cuboid.add(FlipNormal::new(Box::new(XZ::new(
            p0.x(),
            p1.x(),
            p0.z(),
            p1.z(),
        ...
        cuboid.add(FlipNormal::new(Box::new(YZ::new(
            p0.y(),
            p1.y(),
            p0.z(),
            p1.z(),
...
impl Hitable for Translate {
    ...
    fn bounding_box(&self, t0: f32, t1: f32) -> Option<AABB> {
        match self.p.bounding_box(t0, t1) {
            Some(bbox) => Some(AABB {
